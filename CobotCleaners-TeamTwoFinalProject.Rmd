...
```{r}
#load the data
robotData<-read.csv(file="RobotData.csv") 
...
$$
 \begin{split}
 \begin{aligned}
    \text{Maximize  }   &  \sum_{i=1}^{NResources} P_i x_i \\
...
We can't clean part of a house, so let's hone our model further to see what else we can come up with.
