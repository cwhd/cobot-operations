...
$$
 ...
 \begin{aligned}
    ...
    \text{subject to } & \sum_{i=1}^{NResources} R_{i,j}x_i \leq A_j \; \forall \; j\\
                       & x_i \geq 0  \; \forall \; i
  \end{aligned}
  \end{split}
  (\#eq:Algebraic Model)
...
I think this means Robots 3, 4, and 5 are our primary constrainted resources and we should invest in them to make more $. Let's try to add a few more of robots to see what happens.
...
```{r}
NCust <- customerLocationData$Customer
